...
const Header = () => {
  ...
  const handleMouseEnter = () => {
    if (window.innerWidth > 480) setIsOpen(true);
  };
          ...
          >
            ...
            {isOpen && (
              <DroppedBox>
                ...
                <LinkWrapper
                  onClick={() => handleNavigation("/dormitory/myounghyun")}
                >
                  <FaHome style={{ marginRight: "8px" }} /> 명현
                </LinkWrapper>
                <LinkWrapper
                  onClick={() => handleNavigation("/dormitory/dormitory3")}
                >
                  <FaBuilding style={{ marginRight: "8px" }} /> 3동
                </LinkWrapper>
                <LinkWrapper
                  onClick={() => handleNavigation("/dormitory/dormitory4")}
                >
                  <FaBuilding style={{ marginRight: "8px" }} /> 4동
                </LinkWrapper>
                <LinkWrapper
                  onClick={() => handleNavigation("/dormitory/dormitory5")}
                >
